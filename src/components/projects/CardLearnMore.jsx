...
function CardLearnMore({ isHovered }) {
  return (
    <AnimatePresence>
      {isHovered && (
        <motion.div
          className="absolute top-0 right-0 bg-frosted-glass border-t-0 rounded-bl-lg py-0.5 px-1.5 text-sm border-l-2 border-b-2 rounded-tr-md overflow-hidden z-0"
          initial={{ y: '-100%' }}
