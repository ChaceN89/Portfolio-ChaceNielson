...
export const projectDataList = [
    {
        ...
        techStack:["React", "FastAPI", "PostgreSQL", "Tailwind","ChartJS", "Docker"],
        externalLinks:[
    ...
    },
    {
        ...
        techStackName:"Tech Stack",
        techStack:["Python", "Ploty Dash", "CSS", "ML"],
        externalLinks:[
    ...
    },
    {
        ...
        techStackName:"Tools",
        techStack:["Unity", "Blender", "3D Printing", "Cricut Design"],
        externalLinks:[
    ...
    },
    {
        ...
        techStackName:"Tech Stack",
        techStack:["React", "Tailwind", "CSS Animations"],
        externalLinks:[
