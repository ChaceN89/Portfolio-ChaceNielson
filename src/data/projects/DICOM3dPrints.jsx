...
export const dicom3dPrint = {
  ...
  description: long,
  images: [
    { src: "highlight_3dPrint.png", blurhash: "CDKwRrE1?^L~%1RkMxV@" },
    { src: "3dPrint_2.png", blurhash: "CAJ*n-.m01-qE0_3xZNF" },
    { src: "3dPrint_3.png", blurhash: "CsPP+Pf6_NkCoffQRjay" },
    { src: "3dPrint_4.png", blurhash: "C8HLrE00RH_100-xt:Rj" },
    { src: "3dPrint_5.png", blurhash: "CBJ*#c9pS.t100t1R:xt" },
    { src: "3dPrint_6.png", blurhash: "CGI#x_IV~qxt00ay%Mf6" },
    { src: "3dPrint_7.png", blurhash: "CpJ*n~M_~qohjLW9k9og" },
  ],
  mainStack: [
    IconLibrary.BLENDER,
