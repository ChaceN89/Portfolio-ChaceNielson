...
function BreakPointVisual() {
  return (
    <div className="fixed top-0 left-0 m-1 p-1  font-mono z-100 text-white h-6 w-6 rounded-full flex items-center justify-center bg-gray-700 sm:bg-pink-500 md:bg-orange-500 lg:bg-green-500 xl:bg-blue-500 2xl:bg-black">
