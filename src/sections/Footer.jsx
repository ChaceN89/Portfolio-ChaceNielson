...
function Footer() {
  return (
    <footer className=" text-lg bg-white bg-opacity-10 backdrop-blur-xl shadow-lg h-fit py-6">
      <div className="container mx-auto flex flex-col items-center space-y-4 md:space-y-0 md:flex-row md:space-x-5 md:justify-around h-fit">
        <img className="w-fit h-52 sm:h-36 rounded-full object-top my-1" src={process.env.PUBLIC_URL + '/photos/portraits/portrait1.jpg'} alt="..."/>
